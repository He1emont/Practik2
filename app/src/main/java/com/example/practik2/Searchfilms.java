...
public class Searchfilms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_searchfilms);
        tvInfo = (TextView) findViewById(R.id.tvInfo);
        tvName = (EditText) findViewById(R.id.editTextTextPersonName);
    }
    public void onclick(View v){
        Searchfilms.MyTask mt = new Searchfilms.MyTask();
    ...
    class MyTask extends AsyncTask<String,Void, ArrayList<String[]>> {
        ...
        protected void onPostExecute(ArrayList<String[]> result){
            ...
            Searchfilms.ClAdapter clAdapter = new Searchfilms.ClAdapter(tvInfo.getContext(),result);
    ...
    class ClAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (view == null) {
                view = lInflater.inflate(R.layout.itemn, parent, false);
            };
